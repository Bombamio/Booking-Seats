...
class UserBase(BaseModel):
    ...
    username: str = Field(min_length=ct.MIN_USERNAME_LEN,
                          max_length=ct.MAX_USERNAME_LEN)
...
class UserCreate(UserBase):
    ...
    password: str = Field(min_length=ct.MIN_PASSWORD_LEN,
...
class UserUpdate(BaseModel):
    ...
    username: Optional[str] = Field(min_length=ct.MIN_USERNAME_LEN,
                                    max_length=ct.MAX_USERNAME_LEN)
